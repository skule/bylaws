...
&& General
	...
	&&& Candidates are limited to zero dollars (\$0) in campaign expenses, unless the candidate does not have a printing quota with the Engineering Computing Facility (ECF), in which case it is left to the discretion of the CRO.
		&&&& For the purposes of campaign expenses, objects shall be judged at reasonable market value, at the discretion of the CRO, and not the value for which they were obtained. For clarity, this declares that objects that were obtained by the candidates for free but that have value (e.g. food) shall be considered expenses greater than \$0 for the purposes of this rule.
