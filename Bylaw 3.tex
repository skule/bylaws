...
&& Speaker of the Board of Directors Election Period
	...
	&&& The hiring committee shall follow the interview process outlined in Section 7.2.
...
a. Nominees nominated for two (2) or more positions may request the CRO to elect their preferred position first, which must be done at least one (1) day before the April Board of Directors Meeting.
&& Elections
...
&& General
	...
	&&& The CRO shall maintain a document containing voter statements and platforms of all candidates who wish to submit such materials. The permitted lengths of each shall be announced prior to the beginning of the campaigning period, and shall be left to the discretion of the CRO.
		&&&& Notwithstanding sections 8.2.1 and 8.2.3, the link to this document, as well as statements which would be permitted under 8.7, may be posted on any social media platform during the election period.
	&&& Under exceptional circumstances that affect the conditions of campaigning, the CRO may amend sections 8.1 and/or 8.2 for the duration of a single election cycle, provided that the following conditions are met:
		&&&& The amendments are approved by a 2/3 majority of the Board of Directors.
		&&&& The amendments are clearly noted by the CRO in the All Candidates Meeting.
		&&&& A list of the amendments is distributed to all candidates by email no more than 24 hours after the end of the All Candidates Meeting.
...
&& Social Media
	&&& Facebook and Instagram are the sole social media platforms allowed when campaigning. All activity on Facebook is limited to a candidate’s single, public Facebook election event, profile pictures, and cover photos. All activity on Instagram is limited to a candidate's single, public, non-business Instagram page, created newly for each election, with posts, stories, biography, and profile picture as specified in section 8.2.5, in addition to their personal account's profile picture. Candidates may choose one or both of Instagram/Facebook to use for their campaign.
	&&& Candidates using Facebook must friend the CRO’s personal Facebook account and their assigned Deputy Returning Officer’s (DRO) personal account before the campaign period begins. This information will be distributed at the All Candidates Meeting. Facebook election events must have the CRO and at least 1 DRO as hosts before the candidate can begin inviting Members to the event. Instagram election pages must have the CRO's personal account and at least 1 DRO's personal account as followers prior to sending 'follow requests' to Members.
	&&& Posting messages and sharing campaign events on non-election Facebook or Instagram groups or pages is not allowed.
	&&& There will be a Google document linked from the All Candidates List where the links of all pertinent candidate event pages and accounts will be posted.
	&&& Posts and stories may contain any image and text content that satisfies all other applicable sections of Bylaw 3. 'Tagging' any account other than the candidate's personal account is not permitted. The profile picture must satisfy all other applicable sections of Bylaw 3. The biography link must be vote.skule.ca, and the text must satisfy all other applicable sections of Bylaw 3. Instagram election pages may send 'friend requests' only to Members. Candidates are also permitted to change their personal Instagram account's profile picture but may not make any posts or stories on their personal account other than content that would be permitted after the campaign period as specified in Bylaw 3, section 8.7.
