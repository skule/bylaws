...
&& Interpretation and Definitions
	&&& In any situations where this Bylaw contradicts Bylaw 1, Bylaw 1 shall have precedence.
		&&&& Notwithstanding Bylaw 1, the interpretation and enforcement of this Bylaw during Election Periods is the sole jurisdiction of the Chief Returning Officer (with substantive decisions subject to appeal by the process described in Chapter 10). The CRO shall consult with the Speaker to ensure fair and consistent interpretations and judgements in accordance with the Bylaws and the principles of fundamental justice.
	&&& In this document:
...
&& Roles and Responsibilities
	...
	&&& The CRO shall regularly update online content for elections with relevant information, including, but not limited to, election notices and election results.
...
&& Election Period for the CRO
	&&& There shall be a CRO elected each year, whose election shall take place during the Joint Council Meeting following the election of all other positions.
	&&& The CRO shall be elected through the same election procedure as Project Directors, as outlined in Chapter 4.
...
&& By-Elections
	&&& Should an Officer position become vacant during the school year between the first day of classes and the Joint Council Meeting, the CRO shall immediately call a by-election.
	&&& Notification of the By-Election shall be sent by email to all Members.
	&&& The Nomination Period shall be five (5) days.
...
&& Board of Directors Election Period
	...
	&&& The Voting Period shall:
		&&&& Commence between twelve (12) and seventy-two (72) hours after the end of the Campaign Period; and
		&&&& Be between two (2) and three (3) business days (inclusive) in length.
&& Ex-Officio Directors Election Period
	&&& The Nomination, Campaign, and Voting Periods for the following Ex-Officio Director positions shall be the same as those for the Board of Directors election:
		...
		&&&& The Materials Chair, elected by the Materials Science and Engineering constituency; and
		&&&& The Mining Chair, elected by the Mineral Engineering constituency.
	&&& A Member shall be considered nominated upon submitting a completed Nomination Package to the Engineering Society Office, no later than the close of the Nomination Period, which shall include:
		&&&& The Member's name, student number, contact information, and signature.
&& Discipline ?Club Executives Election Period
	&&& The constitution of each Discipline Club shall determine the means of appointment or election for members of its Executive Committee, except for the Chair.
	&&& The Nomination, Campaign, and Voting Periods for all Discipline Club Executive Committee members elected through the Society shall be the same as those for the Board of Directors election.
	&&& A Member shall be considered nominated upon submitting a completed Nomination Package to the Engineering Society Office, no later than the close of the Nomination Period, which shall include:
		&&&& The Member's name, student number, contact information, and signature.
...
&& First Year Board of Directors Election Period
	...
	&&& The Voting Period shall:
		...
		&&&& Be between two (2) and three (3) business days (inclusive) in length.
&& Ex-Officio Directors Election Period
	&&& The Nomination, Campaign, and Voting Periods for the following Ex-Officio Director positions shall be the same as those for the First Year Board of Directors election:
		...
		&&&& The Part-Time Student's Chair, elected by the membership.
	&&& A Member shall be considered nominated upon submitting a completed Nomination Package to the Engineering Society Office, no later than the close of the Nomination Period, which shall include:
		&&&& The Member's name, student number, contact information, and signature.
...
&& Orientation Director Election Period
	&&& The Nomination Period for the Orientation Director, as described in Bylaw 2, shall commence at 9:00am on the first day of class in the Winter Semester and shall close at 5:00pm five (5) business days later.
	&&& A Member shall be considered nominated upon submitting a completed Nomination Package to the Engineering Society Office, no later than the close of the Nomination Period, which shall include:
		&&&& The Member's name, student number, contact information, and signature; and
	...
	&&& At a Special Meeting of the Board of Directors in January, called for the purpose of electing an Orientation Director, each candidate shall be given the opportunity to speak for two (2) minutes before the election for this position.
...
&& Other Elections and Appointments
	&&& The following Ex-Officio Director positions have external or separate appointment or election processes:
		&&&& The UTSU Representatives are elected by the Membership;
		&&&& The Blue \& Gold Chair is elected by the Blue \& Gold committee;
		&&&& The Chief Attiliator is appointed by the outgoing Chief Attiliator;
		&&&& The Seenyur Bnad Leedur is appointed by the Lady Godiva Memorial Bnad (LGMB) according to the ancient and honoured traditions of the LGMB;
		&&&& The Skule Nite Liaison is appointed by the Skule Nite Director;
		&&&& The Student Governor is elected by the full-time undergraduate students of the Professional Faculties; and
		&&&& The President of the You're Next Career Network (YNCN) is appointed by the YNCN Board of Directors.
\end{easylist}
...
&& Project Directors
	...
	&&& The Nomination Period for Project Directors shall be as follows:
		&&&& For Project Directors elected at the JCM, the Nomination Period shall commence no later than 9:00 am on the Monday of the fourth week after Reading Week in the Winter Term, and shall close at 5:00 pm on the Friday of the same week;
		&&&& For all other Project Directorships, the Nomination Period shall be described in their position description in Bylaw 2 (Directors), Chapter 1 (Project Directors); and
 In the event that a Project Director position is vacant, the Nomination Period shall be five (5) business days and the election shall occur at the first Board meeting thereafter.
	&&& Members may be nominated for a maximum of three (3) Project Director positions.
	...
	&&& Each candidate shall be given the opportunity to speak for two (2) minutes before the election in which they are nominated.
	&&& If a Member wins an election for a position, they shall be removed from consideration for any others.
	&&& Each Project Director shall be elected by a show of hands:
		...
		&&&& In all cases of ties, the CRO shall cast the deciding vote; and
		&&&& When only one candidate is nominated, voters shall vote 'yes' or 'no'.
...
&& General
	...
	&&& The campaigning rules outlined in this Chapter apply to: Officers, Board of Directors, First Year Representatives of the Board of Directors, Discipline Club Executives, Class Representatives, Referenda, and Ex-Officio Directors who run their elections through the Engineering Society.
&& Materials
...
&& Voting Method
	...
	&&& The quota of votes needed to win is calculated using the Droop quota, (N/(S+1)) + 1, where N is the number of valid first preference votes and S is the total number of seats needed to be filled in the election (i.e., fractional votes are dropped).
