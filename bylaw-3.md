...
1. If a recommendation report supports more candidates than positions, or is undecided, then the motion to adopt the recommendation shall be treated as a motion to conduct elections in accordance with [section 0.6 of the Standing Rules of Order](standing-rules.md).
