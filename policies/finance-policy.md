...
1. This document outlines:
   ...
   1. The procedures involved with requesting funds from the Engineering Society;
...
1. In addition to any application requirements outlined in each funding avenue's Terms of Reference, an application must:
   1. Contain the applicant's identity and contact information;
   1. Contain an explanation pursuant to the requirements set out in the relevant Terms of Reference;
   1. Contain a budget describing all projected expenses, and where applicable, income.
...
1. All requests for reimbursement shall use the cheque requisition form provided by the Engineering Society. The form may be found in the Engineering Society office, or on the Engineering Society website, and must be submitted to the Vice President Finance through:
   ...
   1.	Any other method that the Vice-President Finance may specify at their discretion.
1. A cheque requisition shall contain:
   1. The name of the person to be reimbursed and suitable contact information;
   1. The funding avenue and organisation that funding was approved towards;
   1. A description of what was purchased;
   1. Original, itemized purchase receipts from the place of purchase (card machine receipts are not acceptable);
...
1.	The Finance Committee shall produce an end of year financial report to be presented at the April Board of Directors Meeting. The report must include:
   1.	A final copy of the Society budget with actual expenditures; and
   1.	A summary of all funding requests that were examined by the Finance Committee that year
1.	The Vice-President Finance shall ensure that the following information is made available on the Society’s website in a timely fashion after approval:
   1.	The amount of any funding allocation made under the above funding avenues;
   1.	The amount of each allocation from the Skule™ Endowment Fund; and
...
1. Trial status clubs may only receive at most $200 per year across all funding avenues, and shall only receive more funding if they successfully receive full status.

# Project Directorship / Associated Entity Funding
## General
1. Project Directorship / Associated Entity Funding is meant to support Project Directorships and Associated Entities in their day-to-day operations. This funding avenue is specifically meant to support operating costs.
1. Applications to Project Directorship / Associated Entity Funding may be submitted on every month the Finance Committee operates.

## Eligibility
1. The only entities that may apply to this funding avenue are:
   1. EngSoc Project Directorships, including Temporary Project Directorships;
   1. EngSoc Associated Entities.
1. No other entity may apply to this funding avenue.
1. To be eligible for consideration, applications must include the following:
   1. All projected sources of income and expenses;
   1. A quote or evidence for the costs of each line item in the “Expenses” section of the application;
   1. An explanation of the purpose of each line item.

## Evaluation
1. Funds cannot be used to purchase:
   1. Alcohol
...
# Conference Funding
## General
1. Conference Funding has been generously enabled by the donation of from the Faculty of Applied Sciences and Engineering and the associated Alumni Fund. The purpose of this funding avenue is to support students in attending conferences/events for their own personal development or community achievement.
...
1. A hobby conference is any conference that is not an academic conference.
...
1. Conference funding applications must be submitted in the same fiscal year the conference is being held in, unless:
   ...
   1. The conference is held in May or June of a given year, in which the conference funding application may be filed in the preceding fiscal year.

## Evaluation
1. There is no fixed limit as to how much funding any individual may receive, provided any other requirements for this funding avenue are met.
1. All conference funding applications must demonstrate how participation in the conference creates benefits to attendees and the Skule™ community;
1. An application must be solely composed of eligible costs, which satisfy the following criteria:
   1. It is necessary for participation in the conference;
...
1. Furthermore, the following groups are NOT eligible for special projects funding:
   ...
   1. Discipline Clubs
1. To be eligible for consideration, applications must include the following:
   1. Details of the scope of the project and how it will benefit the Skule™ Community
   1. A plan of how the project will be carried out, including a timeline of the work
   1. All projected sources of income and expenses
   1. A quote or evidence for the costs of each line item in the “Expenses” section of the application. Evidence must cite a primary source (e.g. online marketplace screenshot)
   1. An explanation of the purpose of each budgeted line item
...
1. Funds cannot be used to purchase:
   ...
   1. Gift cards
   1. Stationery
1. Funds may not be used for operating expenses.
1. Items that are eligible for special projects funding are items that are one-time expenditures which will not be incurred, in the same or a similar form, again over the course of the recipient's lifetime.
   1. Trial status clubs will only be given $200 per year across all funding sources, including this source.
1. When evaluating how funds should be distributed, the finance committee must consider the following criteria:
   1. Impact on the Skule™ community.
   1. The requester's ability in carrying out the use of funds as intended.
   1. Demonstrated effort to compare and identify the best value among alternatives, if applicable.
   1. Incorporation of good budgeting practices, including the presence of a contingency.

## Distribution and use of funds
1. Funds will be distributed via the *cheque requisition* system outlined in this Policy.
1. Funds must be spent on items cited in the approved application with non-substantive changes to price and quality. Changes to purchases after approval should be communicated with the Vice-President Finance.
...
## Evaluation
1. No budget evaluation is required to benefit from this funding avenue. Provided the requirements of other Bylaws and Polices are met, discipline clubs will benefit from Discipline Club Funding automatically.

## Distribution and use of funds
1. Funds will be distributed in three rounds: once between September and November ("Fall round"), once between January and March ("Winter round"), and once between April and May ("Spring round") of any given year.
1. 60% of a discipline club's total funding from this avenue will be allocated in Fall round. 25% of a discipline club's funding will be allocated in the Winter round. 15% of a discipline club's funding will be allocated in the Spring round.

# Affiliated Club Funding
## General
1. Affiliated Club Funding is meant to support Engineering Society Affiliated clubs with their annual, day-to-day operations. This funding avenue is specifically meant to support operating costs.
1. Affiliated Club Funding materialises in two forms: CPSIF and Winter Club Funding, both of which have the same eligibility criteria but different timings.
   1. CPSIF occurs in the fall term of every year. The deadline is decided by the Faculty of Applied Science and Engineering.
...
1. The following groups are NOT eligible for special projects funding:
   ...
   1. Discipline Clubs
   1. Project Directorships
1. To be eligible for consideration, applications must include the following:
   1. The club’s mission and how it benefits the Skule™ Community
   1. All projected sources of income and expenses
   1. A quote or evidence for the costs of each line item in the “Expenses” section of the application
   1. An explanation of the purpose of each line item
...
1. Funds may only be used for operating expenses.
1. When evaluating how funds should be distributed, the finance committee must consider the following criteria:
   1. How the club provides technical and/or professional value to the community.
   1. How the club provides value through community building.
   1. How inclusive the club’s events are.
   1. The requester's ability in carrying out the use of funds as intended.
   1. Demonstrated effort to compare and identify the best value among alternatives, if applicable.
   1. Incorporation of good budgeting practices, including the presence of a contingency.
   1. How reasonable the requested funding amount is relative to the club’s activities.
1. The above criteria are not watertight components; strength demonstrated in one criterion may compensate for weakenss in another.
...
# Levy Funding
## General
1. Levy Funding is meant to support highly involved clubs with a source of funding beyond that which any other funding avenue may provide.
1. Engineering Society Levies have a maximum duration of two years after which they must be renewed.
1. Applications for Levy Funding are open in February only.
...
## Evaluation
1. Levy funds may only be used for operating expenses.
1. When evaluating a levy application, the Finance Committee must consider the following criteria:
   1. How the club provides technical and/or professional value to the community.
   1. How the club provides value through community building.
   1. How inclusive the club’s events are.
   1. The appropriateness of the levy amount relative to the applicant's mission and activities.
   1. The applicant's ability in carrying out the use of funds as intended.
   1. Incorporation of good budgeting practices, including the presence of a contingency.
   1. Demonstrated effort to compare and identify the best value among alternatives, where applicable.
   1. The absence of other funding avenues which may support the team.
   1. Awareness of the applicant's direct accountability to levy-paying students, and the likelihood of the levy surviving referendum.
1. The Board of Directors may refuse to hold a referendum for an applicant for any reason, including but not limited to:
   ...
   1. If the applicant does not currently posses a levy, the applicant does not currently receive more than $1,000 in affiliated club funding;
...
## Distribution and use of funds
1. This section discusses requirements on receiving funds and maintaining levy group status while a levy is in force.
1. Funds will be distributed in three installments: once between September and November ("Fall round"), once between January and March ("Winter round"), and once between April and May ("Spring round") of any given year.
1. 60% of a discipline club's total funding from this avenue will be allocated in Fall round. 25% of a discipline club's funding will be allocated in the Winter round. 15% of a discipline club's funding will be allocated in the Spring round.
1. To receive the first installment of fees, levy groups must submit to the Vice-President Finance and Vice-President Student Life, no later than on August 31 of any year:
