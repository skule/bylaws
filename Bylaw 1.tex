...
%%%%%
\newcommand{\revdate}{September 27, 2022}
...
&& Qualifications for Membership
	&&& Full Time Members shall be students who are enrolled full-time (as defined by the Faculty) in a degree-seeking program of study in the Faculty and have paid or deferred the Full Time Membership Fees during both Fall and Winter semesters of the Academic Year. Full Time Members retain their membership during the Summer following the Academic Year.
	&&& Part Time Members shall be students who are enrolled part-time (as defined by the Faculty) in a degree-seeking program of study in the Faculty and have paid or deferred the Part Time Membership Fees during either Fall or Winter semesters of the Academic Year. Part Time Members retain their membership during the Summer following the Academic Year, if they were enrolled during the Winter Semester.
	...
	&&& The ``Confidentiality Agreement - Information Sharing” document provides the ability for the President, Speaker and Chief Returning Officer of the Engineering Society to verify a Member’s enrolment status if they hold or are attempting to hold a position through a process administered by the Society.
		&&&& The enrolment status of a Member may be verified in the following circumstances:
			&&&&& During a Nomination Period for every candidate. This is the responsibility of the Chief Returning Officer; and
...
&& Fees
	&&& Full Time members and Part Time Members shall have paid in full or successfully deferred their respective Membership Fees for the Fall and/or Winter semesters of each Academic Year that they are considered a member.
	...
	&&& Any fees to be created or increased except as specified in Section 1.2.4 shall be done so by the Membership through a referendum.
	&&& Any fees to be decreased or removed except as specified in Section 1.2.4 shall be done so by one of:
...
&& Recall
	...
	&&& A Member of the Board of Directors shall adhere to a standard of conduct that includes the following:
		...
		&&&& Should a Member of the Board of Directors be absent from 3 regular meetings with regrets,
		they are to attend a mandatory meeting with the Speaker to explain the circumstances that have
		caused their absences. From this meeting, the Speaker will produce a nonbinding
		recommendation to the Member.
			&&&&& This meeting must be attended by the Member within 30 days of the Speaker’s first
			written request to schedule the meeting. The Speaker may waive this requirement for a maximum
			of an additional 30 days.
			&&&&& If the Member presents a valid accessibility concern, the Speaker should attempt to
			provide reasonable accommodation for the Member.
			&&&&& The Speaker may recommend that the Member resign from their position. If this is the
			case, the recommendation must be presented to the Board of Directors in a discussion item
			submitted by the Speaker. Any personal information about the Member pertinent to the decision
			may only be shared with the consent of the Member in question, and may be presented in-camera
			at their request.
